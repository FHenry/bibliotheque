...
/**
 *	Class to manage PDF template standard_emprunt
 */
class pdf_standard_emprunt extends ModelePDFEmprunt
{
	/**
	 ...
	 *
	 *  @param		Emprunt	$object				Object to generate
	 ...
	 *
	 *  @param	TCPDF		$pdf     		Object PDF
	 *  @param  Emprunt	$object     	Object to show
	...
	protected function _pagehead(&$pdf, $object, $showaddress, $outputlangs, $outputlangsbis = null)
	{
		...
		// Show Draft Watermark
		if (getDolGlobalString('BIBLIOTHEQUE_DRAFT_WATERMARK') && $object->statut == $object::STATUS_DRAFT) {
