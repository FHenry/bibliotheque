...
/**
 *	Class to manage PDF template standard_rookrentadh
 */
class pdf_standard_rookrentadh extends ModelePDFRookRentAdh
{
    /**
	...
	*/
	...
	public function write_file($object, $outputlangs, $srctemplatepath = '', $hidedetails = 0, $hidedesc = 0, $hideref = 0)
	{
	    ...
	    /*
	    if (!empty($conf->global->MAIN_GENERATE_ROOKRENTADH_WITH_PICTURE))
	    {
