...
/**
 *  \file       core/modules/bibliotheque/doc/pdf_standard.modules.php
...
/**
 *	Class to manage PDF template standard_borrow
 */
class pdf_standard_borrow extends ModelePDFBorrow
{
	/**
	...
	public function write_file($object, $outputlangs, $srctemplatepath = '', $hidedetails = 0, $hidedesc = 0, $hideref = 0)
	{
		...
		/*
		if (!empty($conf->global->MAIN_GENERATE_BORROW_WITH_PICTURE))
		{
		...
		*/
		...
		if ($conf->bibliotheque->dir_output.'/borrow') {
			$object->fetch_thirdparty();

			// Definition of $dir and $file
			if ($object->specimen) {
				$dir = $conf->bibliotheque->dir_output.'/borrow';
				$file = $dir."/SPECIMEN.pdf";
			} else {
				$objectref = dol_sanitizeFileName($object->ref);
				$dir = $conf->bibliotheque->dir_output.'/borrow/'.$objectref;
	...
	protected function _pagehead(&$pdf, $object, $showaddress, $outputlangs, $outputlangsbis = null)
	{
		...
		if ($object->statut == $object::STATUS_DRAFT && getDolGlobalString('BIBLIOTHEQUE_DRAFT_WATERMARK')) {
			pdf_watermark($pdf, $outputlangs, $this->page_hauteur, $this->page_largeur, 'mm', dol_escape_htmltag(getDolGlobalString('BIBLIOTHEQUE_DRAFT_WATERMARK')));
		}
