...
/**
 *	Class to manage PDF template standard_book
 */
class pdf_standard_book extends ModelePDFBook
{
	/**
	...
	public function write_file($object, $outputlangs, $srctemplatepath = '', $hidedetails = 0, $hidedesc = 0, $hideref = 0)
	{
		...
		/*
		if (!empty($conf->global->MAIN_GENERATE_BOOK_WITH_PICTURE))
		{
		...
		*/
		...
		if ($conf->bibliotheque->dir_output.'/book') {
			$object->fetch_thirdparty();

			// Definition of $dir and $file
			if ($object->specimen) {
				$dir = $conf->bibliotheque->dir_output.'/book';
				$file = $dir."/SPECIMEN.pdf";
			} else {
				$objectref = dol_sanitizeFileName($object->ref);
				$dir = $conf->bibliotheque->dir_output.'/book/'.$objectref;
