...
/**
 *    	\file       bibliotheque/core/modules/bibliotheque/mod_emprun_standard.php
...
class mod_emprun_standard
{
	...
	public function canBeActivated()
	{
		...
		$sql .= " FROM ".MAIN_DB_PREFIX."bibliotheque_emprun";
	 ...
	 *  Return next value
	 *
	 * 	@param	Propal		$emprun		Object Emprun
	 *  @return string      			Next value
	 */
	public function getNextValue($emprun)
	{
		global $db, $conf;
		...
		$sql .= " FROM ".MAIN_DB_PREFIX."bibliotheque_emprun";
		$sql .= " WHERE ref LIKE '".$db->escape($this->prefix)."____-%'";
		//$sql .= " AND entity IN (".getEntity('emprunnumber', 1, $propal).")";
	 ...
	 */
	public function getNumRef($objforref)
	{
