...
/**
 * \file    core/triggers/interface_99_modBibliotheque_BibliothequeTriggers.class.php
 ...
 *      - interface_99_modBibliotheque_MyTrigger.class.php
...
/**
 *  Class of triggers for Bibliotheque module
 */
class InterfaceBibliothequeTriggers extends DolibarrTriggers
{
	/**
	 * Constructor
	 *
	...
	public function __construct($db)
	{
		...
		$this->family = "demo";
		$this->description = "Bibliotheque triggers.";
		// 'development', 'experimental', 'dolibarr' or version
		$this->version = 'development';
		$this->picto = 'bibliotheque@bibliotheque';
	}
	...
	{
		if (empty($conf->bibliotheque) || empty($conf->bibliotheque->enabled)) {
		...
		switch ($action) {
			...
			case 'BOOKRENTADH_DELETE':
			case 'BOOKRENTADH_MODIFY':
			case 'BOOKRENTADH_CREATE':

				/**
				 * @var $object BookRentAdh
				 */
