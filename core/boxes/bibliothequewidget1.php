...
/**
 * \file    bibliotheque/core/boxes/bibliothequewidget1.php
 * \ingroup bibliotheque
 * \brief   Widget provided by Bibliotheque
 *
 ...
 */
class bibliothequewidget1 extends ModeleBoxes
{
	/**
	 * @var string Alphanumeric ID. Populated by the constructor.
	 */
	public $boxcode = "bibliothequebox";

	/**
	 * @var string Box icon (in configuration page)
	 * Automatically calls the icon named with the corresponding "object_" prefix
	 */
	public $boximg = "bibliotheque@bibliotheque";
	 ...
	 */
	public $depends = array('bibliotheque');
	...
	public function __construct(DoliDB $db, $param = '')
	{
		...
		//$this->hidden = ! ($user->rights->bibliotheque->myobject->read);   // Condition when module is visible by user (test on permission)
	}
	...
	public function loadBox($max = 5)
	{
		...
		//dol_include_once("/bibliotheque/class/bibliotheque.class.php");

		// Populate the head at runtime
		$text = $langs->trans("BibliothequeBoxDescription", $max);
		$this->info_box_head = array(
			...
			'subpicto' => 'object_bibliotheque@bibliotheque',
