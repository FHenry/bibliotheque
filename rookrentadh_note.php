...
/**
 *  \file       rookrentadh_note.php
 *  \ingroup    bibliotheque
 *  \brief      Car with notes on RookRentAdh
 */
...
$hookmanager->initHooks(array('rookrentadhnote', 'globalcard')); // Note that conf->hooks_modules contains array
...
$help_url = '';
llxHeader('', $langs->trans('RookRentAdh'), $help_url);
...
if ($id > 0 || !empty($ref))
{
	...
	dol_fiche_head($head, 'note', $langs->trans("RookRentAdh"), -1, $object->picto);
