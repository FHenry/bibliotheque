...
if ($enablepermissioncheck) {
	...
	$permissiontoadd  = $user->hasRight('bibliotheque', 'book', 'write'); // Used by the include of actions_addupdatedelete.inc.php and actions_linkedfiles.inc.php
} else {
	$permissiontoread = 1;
	$permissiontoadd  = 1;
}
...
llxHeader('', $title, $help_url, '', 0, 0, '', '', '', 'mod-bibliotheque page-card_document');
