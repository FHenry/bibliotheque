...
/**
 *  \file       bibliotheque/myobject_contact.php
...
dol_include_once('/bibliotheque/class/myobject.class.php');
dol_include_once('/bibliotheque/lib/bibliotheque_myobject.lib.php');
...
$permission = $user->rights->bibliotheque->myobject->write;
...
if ($object->id) {
	...
	$linkback = '<a href="'.dol_buildpath('/bibliotheque/myobject_list.php', 1).'?restore_lastsearch_values=1'.(!empty($socid) ? '&socid='.$socid : '').'">'.$langs->trans("BackToList").'</a>';
