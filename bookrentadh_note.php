...
/**
 *  \file       bookrentadh_note.php
 *  \ingroup    bibliotheque
 *  \brief      Car with notes on BookRentAdh
 */
...
$hookmanager->initHooks(array('bookrentadhnote', 'globalcard')); // Note that conf->hooks_modules contains array
...
if ($id > 0 || !empty($ref)) $upload_dir = $conf->bibliotheque->multidir_output[$object->entity]."/".$object->id;
...
$help_url = '';
llxHeader('', $langs->trans('BookRentAdh'), $help_url);
...
if ($id > 0 || !empty($ref))
{
	...
	dol_fiche_head($head, 'note', $langs->trans("BookRentAdh"), -1, $object->picto);
