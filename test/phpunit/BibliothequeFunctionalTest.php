...
/**
 * \file    test/phpunit/BibliothequeFunctionalTest.php
...
/**
 * Class BibliothequeFunctionalTest
 *
 ...
 */
class BibliothequeFunctionalTest extends \PHPUnit_Extensions_Selenium2TestCase
{
	...
	public function testModuleEnabled()
	{
		...
		if (strstr($module_status_image->attribute('src'), 'switch_off.png')) {
			// Enable the module
			$this->byHref('modBibliotheque')->click();
		} else {
			// Disable the module
			$this->byHref('modBibliotheque')->click();
			// Reenable the module
	...
	{
		$this->url('/custom/bibliotheque/admin/setup.php');
		$this->authenticate();
		return $this->assertContains('bibliotheque/admin/setup.php', $this->url(), 'Configuration page');
	}
	...
	{
		$this->url('/custom/bibliotheque/admin/about.php');
		$this->authenticate();
		return $this->assertContains('bibliotheque/admin/about.php', $this->url(), 'About page');
	}
	...
	public function testBoxDeclared()
	{
		...
		$this->authenticate();
		return $this->assertContains('bibliothequewidget1', $this->source(), "Box enabled");
	}
	...
	public function testTriggerDeclared()
	{
		...
		return $this->assertContains(
			'interface_99_modBibliotheque_BibliothequeTriggers.class.php',
	...
	public function testTriggerEnabled()
	{
		...
		return $this->assertContains(
			'tick.png',
			$this->byXPath('//td[text()="interface_99_modBibliotheque_MyTrigger.class.php"]/following::img')->attribute('src'),
			"Trigger enabled"
		);
	}
