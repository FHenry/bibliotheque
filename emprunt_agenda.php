...
if ($object->id > 0) {
	$title = $langs->trans("Emprunt")." - ".$langs->trans('Agenda');
	//$title = $object->ref." - ".$langs->trans("Agenda");
	$help_url = 'EN:Module_Agenda_En|DE:Modul_Terminplanung';

	llxHeader('', $title, $help_url, '', 0, 0, '', '', '', 'mod-bibliotheque page-card_agenda');
	...
	print dol_get_fiche_head($head, 'agenda', $langs->trans("Emprunt"), -1, $object->picto);
	...
	if (isModEnabled('agenda') && ($user->hasRight('agenda', 'myactions', 'read') || $user->hasRight('agenda', 'allactions', 'read'))) {
		...
		//$cachekey = 'count_events_emprunt_'.$object->id;
