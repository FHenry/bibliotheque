...
class Emprunt extends CommonObject
{
	 ...
	 */
	public $table_element = 'bibliotheque_emprunt';

	/**
	 * @var string 	If permission must be checkec with hasRight('bibliotheque', 'read') and not hasright('mymodyle', 'emprunt', 'read'), you can uncomment this line
	 */
	//public $element_for_permission = 'bibliotheque';

	/**
	 * @var string 	String with name of icon for emprunt. Must be a 'fa-xxx' fontawesome code (or 'fa-xxx_fa_color_size') or 'emprunt@bibliotheque' if picto is file 'img/object_emprunt.png'.
	 */
	...
	//  */
	// public $table_element_line = 'bibliotheque_empruntline';
	...
	//  */
	// protected $childtables = array('mychildtable' => array('name'=>'Emprunt', 'fk_element'=>'fk_emprunt'));
	...
	//  */
	// protected $childtablesoncascade = array('bibliotheque_empruntdet');
	...
	public function __construct(DoliDB $db)
	{
		...
		/*if ($user->hasRight('bibliotheque', 'emprunt', 'read')) {
	...
	public function validate($user, $notrigger = 0)
	{
		...
		/* if (! ((!getDolGlobalInt('MAIN_USE_ADVANCED_PERMS') && $user->hasRight('bibliotheque', 'emprunt', 'write'))
		 || (getDolGlobalInt('MAIN_USE_ADVANCED_PERMS') && $user->hasRight('bibliotheque', 'emprunt_advance', 'validate')))
		 {
	...
	public function setDraft($user, $notrigger = 0)
	{
		...
		/* if (! ((!getDolGlobalInt('MAIN_USE_ADVANCED_PERMS') && $user->hasRight('bibliotheque','write'))
		 || (getDolGlobalInt('MAIN_USE_ADVANCED_PERMS') && $user->hasRight('bibliotheque','bibliotheque_advance','validate'))))
		 {
	...
	public function getTooltipContentArray($params)
	{
		...
		if (getDolGlobalInt('MAIN_OPTIMIZEFORTEXTBROWSER')) {
			return ['optimize' => $langs->trans("ShowEmprunt")];
		}
		$datas['picto'] = img_picto('', $this->picto).' <u>'.$langs->trans("Emprunt").'</u>';
	...
	public function getNomUrl($withpicto = 0, $option = '', $notooltip = 0, $morecss = '', $save_lastsearch_value = -1)
	{
		...
		$url = dol_buildpath('/bibliotheque/emprunt_card.php', 1).'?id='.$this->id;
	...
	public function getLinesArray()
	{
		...
		$result = $objectline->fetchAll('ASC', 'position', 0, 0, '(fk_emprunt:=:'.((int) $this->id).')');
...
class EmpruntLine extends CommonObjectLine
{
	 ...
	 */
	public $parent_element = '';		// Example: '' or 'emprunt'

	/**
	 * To overload
	 * @see CommonObjectLine
	 */
	public $fk_parent_attribute = '';	// Example: '' or 'fk_emprunt'
