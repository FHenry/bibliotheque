...
class BookRentAdh extends CommonObject
{
	 ...
	 */
	//public $table_element_line = 'bibliotheque_rookrentadhline';

	/**
	 * @var int    Field with ID of parent key if this object has a parent
	 */
	//public $fk_element = 'fk_rookrentadh';

	/**
	 * @var int    Name of subtable class that manage subtable lines
	 */
	//public $class_element_line = 'RookRentAdhline';
	 ...
	 */
	//protected $childtablesoncascade = array('bibliotheque_rookrentadhdet');

	/**
	 * @var RookRentAdhLine[]     Array of subtable lines
	 */
	//public $lines = array();
	...
	public function __construct(DoliDB $db)
	{
		...
		if (version_compare(DOL_VERSION, '14.0.0') >= 0) {
			$this->fields['fk_adherent'] = array('type'=>'integer:Adherent:/adherents/class/adherent.class.php:0:statut=1 AND datefin >= NOW()', 'label'=>'Members', 'enabled'=>'1', 'position'=>50, 'notnull'=>1, 'visible'=>1, 'index'=>1, 'help'=>"LinkToMembers",);
		}
	...
	public function getNomUrl($withpicto = 0, $option = '', $notooltip = 0, $morecss = '', $save_lastsearch_value = -1)
	{
		...
		if (empty($notooltip)) {
			if (!empty($conf->global->MAIN_OPTIMIZEFORTEXTBROWSER)) {
				$label = $langs->trans("ShowRookRentAdh");
		...
		$hookmanager->initHooks(array('rookrentadhdao'));
	...
	public function getLinesArray()
	{
		...
		$objectline = new RookRentAdhLine($this->db);
		$result = $objectline->fetchAll('ASC', 'position', 0, 0, array('customsql'=>'fk_rookrentadh = '.$this->id));
...
/**
 * Class RookRentAdhLine. You can also remove this and generate a CRUD class for lines objects.
 */
class RookRentAdhLine
{
	// To complete with content of an object RookRentAdhLine
	// We should have a field rowid, fk_rookrentadh and position
